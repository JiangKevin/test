...
void ConfigureEngine( asIScriptEngine* engine )
{
    ...
    cout << "+++++ AS Library Options +++++ " << asGetLibraryOptions() << endl;
    cout << "+++++ AS Library Options +++++ " << ( strstr( asGetLibraryOptions(), "AS_MAX_PORTABILITY" ) == 0 ) << endl;

    if ( ! strstr( asGetLibraryOptions(), "AS_MAX_PORTABILITY" ) )
    {
        cout << "+++++ AS_MAX_PORTABILITY +++++++" << endl;
    ...
    {
        cout << "+++++ No AS_MAX_PORTABILITY +++++++" << endl;
