...
/// exposed constructor should have unique name, otherwise the early one will be
/// overwriten.
...
namespace LUAAA_NS
{
    ...
    template < typename TRET, typename CLASS, typename... ARGS > struct function_traits< TRET ( CLASS::* )( ARGS... ) const >
    {
        using function_type = std::function< TRET( ARGS... ) >;
    };

    template < typename F > using function_type_t = typename function_traits< F >::function_type;

    template < typename F > function_type_t< F > to_function( F& f )
    {
        return static_cast< function_type_t< F > >( f );
    }

    // to_class_getter_function
    template < typename TCLASS, typename F > struct class_getter_function_traits : public class_getter_function_traits< TCLASS, decltype( &F::operator() ) >
    {
    };

    template < typename TCLASS, typename TRET, typename CLASS, typename ARG, typename... ARGS > struct class_getter_function_traits< TCLASS, TRET ( CLASS::* )( ARG, ARGS... ) const >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ) && ( std::is_same< typename std::decay< TCLASS >::type, typename std::decay< ARG >::type >::value ), "Error: property getter does not accept param except current "
                                                                                                                                                       "Class reference." );
        using function_type = std::function< TRET( ARG, ARGS... ) >;
    };

    template < typename TCLASS, typename TRET, typename CLASS > struct class_getter_function_traits< TCLASS, TRET ( CLASS::* )() const >
    {
        using function_type = std::function< TRET() >;
    };

    template < typename TCLASS, typename F > using class_getter_function_type_t = typename class_getter_function_traits< TCLASS, F >::function_type;

    template < typename TCLASS, typename F > class_getter_function_type_t< TCLASS, F > to_class_getter_function( F& f )
    {
        return static_cast< class_getter_function_type_t< TCLASS, F > >( f );
    }

    // to_class_setter_function
    template < typename TCLASS, typename F > struct class_setter_function_traits : public class_setter_function_traits< TCLASS, decltype( &F::operator() ) >
    {
    };

    template < typename TCLASS, typename TRET, typename CLASS, typename ARG1, typename... ARGS > struct class_setter_function_traits< TCLASS, TRET ( CLASS::* )( ARG1, ARGS... ) const >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ) || ( ( sizeof...( ARGS ) == 1 ) && std::is_same< typename std::decay< TCLASS >::type, typename std::decay< ARG1 >::type >::value ), "Error: property setter accepts only [1 value] or [self "
                                                                                                                                                                                      "instance and 1 value]." );
        using function_type = std::function< TRET( ARG1, ARGS... ) >;
    };

    template < typename TCLASS, typename TRET, typename CLASS, typename ARG1 > struct class_setter_function_traits< TCLASS, TRET ( CLASS::* )( ARG1 ) const >
    {
        using function_type = std::function< TRET( ARG1 ) >;
    };

    template < typename TCLASS, typename F > using class_setter_function_type_t = typename class_setter_function_traits< TCLASS, F >::function_type;

    template < typename TCLASS, typename F > class_setter_function_type_t< TCLASS, F > to_class_setter_function( F& f )
    {
        return static_cast< class_setter_function_type_t< TCLASS, F > >( f );
    }

    // to_module_getter_function
    template < typename F > struct module_getter_function_traits : public module_getter_function_traits< decltype( &F::operator() ) >
    {
    };

    template < typename TRET, typename... ARGS > struct module_getter_function_traits< TRET ( * )( ARGS... ) >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ), "Error: property getter does not accept param." );
        using function_type = std::function< TRET( ARGS... ) >;
    };

    template < typename TRET, typename CLASS, typename... ARGS > struct module_getter_function_traits< TRET ( CLASS::* )( ARGS... ) const >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ), "Error: property getter does not accept param." );
        using function_type = std::function< TRET( ARGS... ) >;
    };

    template < typename F > using module_getter_function_type_t = typename module_getter_function_traits< F >::function_type;

    template < typename F > module_getter_function_type_t< F > to_module_getter_function( F& f )
    {
        return static_cast< module_getter_function_type_t< F > >( f );
    }

    // to_module_setter_function
    template < typename F > struct module_setter_function_traits : public module_setter_function_traits< decltype( &F::operator() ) >
    {
    };

    template < typename TRET, typename ARG1, typename... ARGS > struct module_setter_function_traits< TRET ( * )( ARG1, ARGS... ) >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ), "Error: property setter accepts only 1 value." );
        using function_type = std::function< TRET( ARG1, ARGS... ) >;
    };

    template < typename TRET, typename CLASS, typename ARG1, typename... ARGS > struct module_setter_function_traits< TRET ( CLASS::* )( ARG1, ARGS... ) const >
    {
        static_assert( ( sizeof...( ARGS ) == 0 ), "Error: property setter accepts only 1 value." );
        using function_type = std::function< TRET( ARG1, ARGS... ) >;
    };

    template < typename F > using module_setter_function_type_t = typename module_setter_function_traits< F >::function_type;

    template < typename F > module_setter_function_type_t< F > to_module_setter_function( F& f )
    {
    ...
    template <> struct LuaStack< float >
    {
    ...
    template <> struct LuaStack< lua_State* >
    {
    ...
    template < typename T > inline void LuaStackReturn( lua_State* L, T t )
    {
        lua_settop( L, 0 );
        LuaStack< T >::put( L, t );
    }
...
#define IMPLEMENT_CALLBACK_INVOKER( CALLCONV )                                                            \
    template < typename RET, typename... ARGS > struct LuaStack< RET( CALLCONV* )( ARGS... ) >            \
    {                                                                                                     \
    ...
    template < typename... ARGS > struct LuaStack< void( CALLCONV* )( ARGS... ) >                         \
    {                                                                                                     \
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
    template < typename RET, typename... ARGS > struct LuaStack< std::function< RET( ARGS... ) > >
    {
    ...
    template < typename... ARGS > struct LuaStack< std::function< void( ARGS... ) > >
    {
    ...
    //========================================================
    template < typename TRET, typename FTYPE, typename... ARGS, std::size_t... Ns > TRET LuaInvokeImpl( lua_State* state, void* calleePtr, size_t skip, indices< Ns... > )
    {
        return ( *( FTYPE* )( calleePtr ) )( LuaStack< ARGS >::get( state, Ns + 1 + skip )... );
    }

    template < typename TRET, typename FTYPE, typename... ARGS > inline TRET LuaInvoke( lua_State* state, void* calleePtr, size_t skip )
    {
...
#define IMPLEMENT_FUNCTION_CALLER( CALLERNAME, CALLCONV, SKIPPARAM )                                                   \
    template < typename TRET, typename... ARGS > lua_CFunction CALLERNAME( TRET( CALLCONV* func )( ARGS... ) )         \
    {                                                                                                                  \
    ...
    template < typename... ARGS > lua_CFunction CALLERNAME( void( CALLCONV * func )( ARGS... ) )                       \
    {                                                                                                                  \
        typedef decltype( func ) FTYPE;                                                                                \
        ( void )( func );                                                                                              \
        struct HelperClass                                                                                             \
    ...
    //========================================================
    template < typename TCLASS, typename TRET, typename FTYPE, typename... ARGS, std::size_t... Ns > TRET LuaInvokeInstanceMemberImpl( lua_State* state, void* calleePtr, indices< Ns... > )
    {
        return ( LuaStack< TCLASS >::get( state, 1 ).**( FTYPE* )( calleePtr ) )( LuaStack< ARGS >::get( state, Ns + 2 )... );
    }

    template < typename TCLASS, typename TRET, typename FTYPE, typename... ARGS > inline TRET LuaInvokeInstanceMember( lua_State* state, void* calleePtr )
    {
        return LuaInvokeInstanceMemberImpl< TCLASS, TRET, FTYPE, ARGS... >( state, calleePtr, typename make_indices< sizeof...( ARGS ) >::type() );
    }

    template < typename TCLASS, typename TRET, typename... ARGS > lua_CFunction MemberFunctionCaller( TRET ( TCLASS::*func )( ARGS... ) )
    {
        typedef decltype( func ) FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    template < typename TCLASS, typename TRET, typename... ARGS > lua_CFunction MemberFunctionCaller( TRET ( TCLASS::*func )( ARGS... ) const )
    {
        typedef decltype( func ) FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    template < typename TCLASS, typename... ARGS > lua_CFunction MemberFunctionCaller( void ( TCLASS::*func )( ARGS... ) )
    {
        typedef decltype( func ) FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    template < typename TCLASS, typename... ARGS > lua_CFunction MemberFunctionCaller( void ( TCLASS::*func )( ARGS... ) const )
    {
        typedef decltype( func ) FTYPE;
        ( void )( func );
        struct HelperClass
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
    template < typename TRET, typename... ARGS > lua_CFunction MemberFunctionCaller( const std::function< TRET( ARGS... ) >& func )
    {
    ...
    template < typename... ARGS > lua_CFunction MemberFunctionCaller( const std::function< void( ARGS... ) >& func )
    {
        typedef std::function< void( ARGS... ) > FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    template < typename TRET, typename... ARGS > lua_CFunction NonMemberFunctionCaller( const std::function< TRET( ARGS... ) >& func )
    {
        typedef std::function< TRET( ARGS... ) > FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    template < typename... ARGS > lua_CFunction NonMemberFunctionCaller( const std::function< void( ARGS... ) >& func )
    {
        typedef std::function< void( ARGS... ) > FTYPE;
        ( void )( func );
        struct HelperClass
    ...
    // constructor invoker
    //========================================================
    template < typename TCLASS, typename... ARGS > struct PlacementConstructorCaller
    {
    ...
    private:
        template < std::size_t... Ns > static TCLASS* InvokeImpl( lua_State* state, void* mem, indices< Ns... >, size_t skip )
        {
    ...
    // Destructor invoker
    //========================================================
    template < typename TCLASS, bool = std::is_destructible< TCLASS >::value > struct DestructorCaller
    {
    ...
    template < typename TCLASS > struct DestructorCaller< TCLASS, false >
    {
        static void Invoke( TCLASS* obj )
        {
            // do thing here.
    ...
    // export class
    //========================================================
    template < typename TCLASS, int TAG > struct LuaClass
    {
    ...
    public:
...
#if LUAAA_WITHOUT_CPP_STDLIB
            luaL_argcheck( state, ( klassName == nullptr ), 1,
                           "LuaCalss<CLASS> name conflict, use LuaClass<CLASS, TAG> to "
                           "identify them" );
#else
                ...
                static int f_internal_index( lua_State* state )
                {
                    ...
                    else if ( lua_isnil( state, -1 ) )
                    {
                        ...
                        else
                        {
                            ...
                            if ( lua_isfunction( state, -1 ) )
                            {
                                // Yes, there are something write-only, e.g., stdout, printer,
                                // digital io pin in output mode.
                            ...
                            else
                            {
                                ...
                                // luaL_error(state, "attempt to access Non-exists property '%s'
                                // of '%s'", key, LuaClass<TCLASS, TAG>::klassName);
                            }
                        }
                    }
                    return 1;
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
        LuaClass( lua_State* state, const std::string& name, const luaL_Reg* functions = nullptr ) : LuaClass( state, name.c_str(), functions ) {}
#endif

        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const char* name = "new" )
        {
            struct HelperClass
            {
        ...
        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const char* name, TCLASS* ( *spawner )( ARGS... ) )
        {
        ...
        template < typename TRET, typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const char* name, TCLASS* ( *spawner )( ARGS... ), TRET ( *deleter )( TCLASS* ) )
        {
            typedef decltype( spawner ) SPAWNERFTYPE;
        ...
        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const char* name, TCLASS* ( *spawner )( ARGS... ), std::nullptr_t )
        {
            typedef decltype( spawner ) SPAWNERFTYPE;
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const std::string& name )
        {
            return ctor< ARGS... >( name.c_str() );
        }

        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const std::string& name, TCLASS* ( *spawner )( ARGS... ) )
        {
            return ctor( name.c_str(), spawner );
        }

        template < typename TRET, typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const std::string& name, TCLASS* ( *spawner )( ARGS... ), TRET ( *deleter )( TCLASS* ) )
        {
            return ctor( name.c_str(), spawner, deleter );
        }

        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& ctor( const std::string& name, TCLASS* ( *spawner )( ARGS... ), std::nullptr_t )
        {
            return ctor( name.c_str(), spawner, nullptr );
        }
#endif
    private:
        template < typename F > inline LuaClass< TCLASS, TAG >& _registerClassFunction( const char* name, lua_CFunction caller, F f )
        {
    ...
    private:
        template < typename F > inline LuaClass< TCLASS, TAG >& _funImpl( const char* name, F f )
        {
            return _registerClassFunction( name, MemberFunctionCaller( f ), f );
        }
    public:
        template < typename FCLASS, typename FRET, typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, FRET ( FCLASS::*f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }

        template < typename FCLASS, typename FRET, typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, FRET ( FCLASS::*f )( FARGS... ) const )
        {
            return _funImpl( name, f );
        }

        template < typename FCLASS, typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, void ( FCLASS::*f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }

        template < typename FCLASS, typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, void ( FCLASS::*f )( FARGS... ) const )
        {
            return _funImpl( name, f );
        }

        template < typename FRET, typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, FRET ( *f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }

        template < typename... FARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, void ( *f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }
        ...
        template < typename TRET, typename... ARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, const std::function< TRET( ARGS... ) >& f )
        {
            return _funImpl< std::function< TRET( ARGS... ) > >( name, f );
        }

        template < typename... ARGS > inline LuaClass< TCLASS, TAG >& fun( const char* name, const std::function< void( ARGS... ) >& f )
        {
            return _funImpl< std::function< void( ARGS... ) > >( name, f );
        }

        template < typename F > inline LuaClass< TCLASS, TAG >& fun( const char* name, F f )
        {
        ...
        template < typename V > inline LuaClass< TCLASS, TAG >& def( const char* name, const V& val )
        {
            luaL_getmetatable( m_state, klassName );
            lua_pushstring( m_state, name );
    ...
    private:
        template < typename F > inline LuaClass< TCLASS, TAG >& _getterImpl( const char* name, lua_CFunction invoker, F f )
        {
#if LUAAA_FEATURE_PROPERTY
            char internal_name[ 256 ];
        ...
        template < typename F > inline LuaClass< TCLASS, TAG >& _setterImpl( const char* name, lua_CFunction invoker, F f )
        {
#if LUAAA_FEATURE_PROPERTY
            char internal_name[ 256 ];
            snprintf( internal_name, sizeof( internal_name ), ">%s", name );
    ...
    public:
        template < typename P > inline LuaClass< TCLASS, TAG >& get( const char* name, P ( *f )() )
        {
            struct HelperClass
            {
        ...
        template < typename P > inline LuaClass< TCLASS, TAG >& get( const char* name, P ( *f )( const TCLASS& ) )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P, typename FCLASS > inline LuaClass< TCLASS, TAG >& get( const char* name, P ( FCLASS::*f )() const )
        {
        ...
        template < typename P, typename TRET > inline LuaClass< TCLASS, TAG >& set( const char* name, TRET ( *f )( P ) )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P, typename TRET, typename FCLASS > inline LuaClass< TCLASS, TAG >& set( const char* name, TRET ( FCLASS::*f )( P ) )
        {
        ...
        template < typename P, typename TRET > inline LuaClass< TCLASS, TAG >& set( const char* name, TRET ( *f )( TCLASS&, P ) )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
    ...
    public:
        ...
        template < typename P > inline LuaClass< TCLASS, TAG >& get( const char* name, std::function< P() > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P > inline LuaClass< TCLASS, TAG >& get( const char* name, std::function< P( const TCLASS& ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P > inline LuaClass< TCLASS, TAG >& get( const char* name, std::function< P( TCLASS& ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename F > inline LuaClass< TCLASS, TAG >& get( const char* name, F f )
        {
            return get( name, to_class_getter_function< TCLASS >( f ) );
        }

        template < typename P, typename TRET > inline LuaClass< TCLASS, TAG >& set( const char* name, std::function< TRET( P ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P, typename TRET > inline LuaClass< TCLASS, TAG >& set( const char* name, std::function< TRET( TCLASS&, P ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename P, typename TRET > inline LuaClass< TCLASS, TAG >& set( const char* name, std::function< TRET( const TCLASS&, P ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        template < typename F > inline LuaClass< TCLASS, TAG >& set( const char* name, F f )
        {
    ...
    public:
#if ! LUAAA_WITHOUT_CPP_STDLIB
        template < typename F > inline LuaClass< TCLASS, TAG >& fun( const std::string& name, F f )
        {
            return fun( name.c_str(), f );
        }

        template < typename V > inline LuaClass< TCLASS, TAG >& def( const std::string& name, const V& val )
        {
            return def( name.c_str(), val );
        }

        template < typename F > inline LuaClass< TCLASS, TAG >& get( const std::string& name, F f )
        {
            return get( name.c_str(), f );
        }

        template < typename F > inline LuaClass< TCLASS, TAG >& set( const std::string& name, F f )
        {
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
        LuaModule( lua_State* state, const std::string& name ) : LuaModule( state, name.empty() ? "_G" : name.c_str() ) {}
#endif
    ...
    private:
        ...
        template < typename F > inline LuaModule& _registerModuleFunction( const char* name, lua_CFunction caller, F f )
        {
#if USE_NEW_MODULE_REGISTRY
        ...
        template < typename F > inline LuaModule& _funImpl( const char* name, F f )
        {
            return _registerModuleFunction( name, NonMemberFunctionCaller( f ), f );
        }
    public:
        template < typename FRET, typename... FARGS > inline LuaModule& fun( const char* name, FRET ( *f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }

        template < typename... FARGS > inline LuaModule& fun( const char* name, void ( *f )( FARGS... ) )
        {
            return _funImpl( name, f );
        }

#if ! LUAAA_WITHOUT_CPP_STDLIB
        template < typename TRET, typename... ARGS > inline LuaModule& fun( const char* name, const std::function< TRET( ARGS... ) >& f )
        {
            return _funImpl< std::function< TRET( ARGS... ) > >( name, f );
        }

        template < typename... ARGS > inline LuaModule& fun( const char* name, const std::function< void( ARGS... ) >& f )
        {
            return _funImpl< std::function< void( ARGS... ) > >( name, f );
        }

        template < typename F > inline LuaModule& fun( const char* name, F f )
        {
            return fun( name, to_function( f ) );
        }
#endif
        ...
        template < typename V > inline LuaModule& def( const char* name, const V& val )
        {
#if USE_NEW_MODULE_REGISTRY
            lua_getglobal( m_state, m_moduleName );
            if ( lua_isnil( m_state, -1 ) )
        ...
        template < typename TCLASS, int TAG > inline LuaModule& def( const char* name, const luaaa::LuaClass< TCLASS, TAG >&, const TCLASS* obj = nullptr, void ( *deleter )( TCLASS* ) = nullptr )
        {
        ...
        template < typename V > inline LuaModule& def( const char* name, const V val[], size_t length )
        {
#if USE_NEW_MODULE_REGISTRY
            lua_getglobal( m_state, m_moduleName );
            if ( lua_isnil( m_state, -1 ) )
...
#if ! LUAAA_WITHOUT_CPP_STDLIB
        template < typename F > inline LuaModule& fun( const std::string& name, F f )
        {
            return fun( name.c_str(), f );
        }

        template < typename V > inline LuaModule& def( const std::string& name, const V& val )
        {
            return def( name.c_str(), val );
        }
#endif
    private:
        template < typename F > inline LuaModule& _getterImpl( const char* name, lua_CFunction invoker, F f )
        {
#if LUAAA_FEATURE_PROPERTY
            char internal_name[ 256 ];
            snprintf( internal_name, sizeof( internal_name ), "<%s", name );
        ...
        template < typename F > inline LuaModule& _setterImpl( const char* name, lua_CFunction invoker, F f )
        {
#if LUAAA_FEATURE_PROPERTY
            char internal_name[ 256 ];
            snprintf( internal_name, sizeof( internal_name ), ">%s", name );
    ...
    public:
        template < typename P > inline LuaModule& get( const char* name, P ( *f )() )
        {
        ...
        template < typename P, typename TRET > inline LuaModule& set( const char* name, TRET ( *f )( P ) )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
    ...
    public:
#if ! LUAAA_WITHOUT_CPP_STDLIB
        // access prop from lambdas
        template < typename P > inline LuaModule& get( const char* name, std::function< P() > f )
        {
            static_assert( ! std::is_void< P >::value, "Error: getter function must return a value." );
            struct HelperClass
            {
        ...
        template < typename F > inline LuaModule& get( const char* name, F f )
        {
            return get( name, to_module_getter_function( f ) );
        }

        template < typename P, typename TRET > inline LuaModule& set( const char* name, std::function< TRET( P ) > f )
        {
            struct HelperClass
            {
                static inline int Invoke( lua_State* state )
        ...
        // {
        //     //static_assert(std::false_type::value, "Error: invalid signature of
        //     setter function");
        //     //assert(!"Error: invalid signature of setter function");
        //     return (*this);
        // }

        template < typename F > inline LuaModule& set( const char* name, F f )
        {
            return set( name, to_module_setter_function( f ) );
        }

        template < typename F > inline LuaModule& get( const std::string& name, F f )
        {
            return get( name.c_str(), f );
        }

        template < typename F > inline LuaModule& set( const std::string& name, F f )
        {
            return set( name.c_str(), f );
        }
#endif
...
{
    // array
    template < typename K, size_t N > struct LuaStack< std::array< K, N > >
    {
    ...
    // vector
    template < typename K, typename... ARGS > struct LuaStack< std::vector< K, ARGS... > >
    {
    ...
    // deque
    template < typename K, typename... ARGS > struct LuaStack< std::deque< K, ARGS... > >
    {
    ...
    // list
    template < typename K, typename... ARGS > struct LuaStack< std::list< K, ARGS... > >
    {
    ...
    // forward_list
    template < typename K, typename... ARGS > struct LuaStack< std::forward_list< K, ARGS... > >
    {
    ...
    // set
    template < typename K, typename... ARGS > struct LuaStack< std::set< K, ARGS... > >
    {
    ...
    // multiset
    template < typename K, typename... ARGS > struct LuaStack< std::multiset< K, ARGS... > >
    {
    ...
    // unordered_set
    template < typename K, typename... ARGS > struct LuaStack< std::unordered_set< K, ARGS... > >
    {
    ...
    // unordered_multiset
    template < typename K, typename... ARGS > struct LuaStack< std::unordered_multiset< K, ARGS... > >
    {
    ...
    // map
    template < typename K, typename V, typename... ARGS > struct LuaStack< std::map< K, V, ARGS... > >
    {
    ...
    // multimap
    template < typename K, typename V, typename... ARGS > struct LuaStack< std::multimap< K, V, ARGS... > >
    {
    ...
    // unordered_map
    template < typename K, typename V, typename... ARGS > struct LuaStack< std::unordered_map< K, V, ARGS... > >
    {
    ...
    // unordered_multimap
    template < typename K, typename V, typename... ARGS > struct LuaStack< std::unordered_multimap< K, V, ARGS... > >
    {
    ...
    // std::pair
    template < typename U, typename V > struct LuaStack< std::pair< U, V > >
    {
    ...
    template < typename Tuple, std::size_t... Index, typename = typename std::enable_if< is_tuple< Tuple >::value >::type > inline void load_tuple_from_lua_table( lua_State* L, int idx, Tuple& tuple, std::index_sequence< Index... > )
    {
        luaL_argcheck( L, lua_istable( L, idx ), 1, "required table not found on stack." );
        if ( lua_istable( L, idx ) )
        {
            lua_pushnil( L );
            ( void )std::initializer_list< int >{ ( lua_next( L, idx ) && ( std::get< Index >( tuple ) = LuaStack< decltype( std::get< Index >( tuple ) ) >::get( L, lua_gettop( L ) ), 1 ) && ( lua_pop( L, 1 ), 1 ), 0 )... };
        }
    }

    template < typename Tuple, std::size_t... Index, typename = typename std::enable_if< is_tuple< Tuple >::value >::type > inline void save_tuple_to_lua_table( lua_State* L, const Tuple& tuple, std::index_sequence< Index... > )
    {
        lua_newtable( L );
        ( void )std::initializer_list< int >{ ( LuaStack< decltype( std::get< Index >( tuple ) ) >::put( L, std::get< Index >( tuple ) ), lua_rawseti( L, -2, Index + 1 ), 0 )... };
    }

    template < typename... TS > struct LuaStack< std::tuple< TS... > >
    {
    ...
    #elif __cplusplus
    template < typename T, size_t N > struct TupleAccessor
    {
    ...
    template < typename T > struct TupleAccessor< T, 1 >
    {
        static void get( lua_State* L, int idx, T& tuple )
        {
            if ( lua_next( L, idx ) )
    ...
    template < typename T > struct TupleAccessor< T, 0 >
    {
